...
public class NewSplitWindowWizard extends Wizard implements INewWizard {
	
	private DiagramCreationPage pathPage;

	public NewSplitWindowWizard() {
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		pathPage.setBaseFileName("splitwindow");
	}
	...
	protected Diagram createFileContent(IFile iFile) {
		...
		diagram.getScreen().setDialog(new SplitWindow());
		return diagram;
	}
