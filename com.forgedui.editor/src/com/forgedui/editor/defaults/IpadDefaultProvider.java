...
public class IpadDefaultProvider extends IphoneDefaultsProvider {
	
	private static final Platform p = Platform.iPad;
	...
	static {
		...
		//Popover
		sizeMap.put(getKey(p, Popover.class), new Dimension(320, 100));
		colorMap.put(getKey(p, Popover.class, BACKGROUND), new RGB(0x0, 0x0, 0x0));
		colorMap.put(getKey(p, Popover.class, BORDER), new RGB(0x0, 0x0, 0x0));
		showGradient.add(getKey(p, Popover.class));
		
		//SplitWindow
		sizeMap.put(getKey(p, SplitWindow.class), new Dimension(320, 100));
		colorMap.put(getKey(p, SplitWindow.class, BACKGROUND), new RGB(0x0, 0x0, 0x0));
		showGradient.add(getKey(p, SplitWindow.class));
	}
	
	/*pacakge*/ IpadDefaultProvider(){
